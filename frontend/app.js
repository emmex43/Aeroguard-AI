...
// ── Alarm System ───────────────────────────────────────
const alarm = new Audio("assets/alarm.mpeg");
alarm.loop = true;
...
function triggerAlarm() {
  ...
  document.getElementById("stat-status").closest("div").classList.add("alarm-flash");
}
...
function acknowledgeAlarm() {
  ...
  document.getElementById("stat-status").closest("div").classList.remove("alarm-flash");

  console.log("Alarm acknowledged by operator");
}
